...
local unpack, table_concat, byte, char, string_rep, sub, string_format, floor, ceil, min, max = table.unpack or unpack, table.concat, string.byte, string.char, string.rep, string.sub, string.format, math.floor, math.ceil, math.min, math.max
...
local function benchmark()
   print("[STR_ENCRYPT]Benchmarking (calculating SHA512 of 10KByte string of letters 'a')...")
   ...
   print("[STR_ENCRYPT]Result = "..result)

   -- get median time
   table.sort(time_intervals)
   print('[STR_ENCRYPT]CPU seconds:', time_intervals[k])
